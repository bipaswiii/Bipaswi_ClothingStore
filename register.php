          ...
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              ...
              <form method="POST" action="action.php">
                ...
                <div class="form-outline mb-4">
                  <input type="text" id="form3Example4cdg" class="form-control form-control-lg" name="facebook" />
                  <label class="form-label" for="form3Example4cdg">Facebook Link</label>
                </div>

                <div class="form-outline mb-4">
                  <input type="text" id="form3Example4cdg" class="form-control form-control-lg" name="instagram" />
                  <label class="form-label" for="form3Example4cdg">Instagram Link</label>
                </div>
                <div class="form-outline mb-4">
                  <input type="text" id="form3Example4cdg" class="form-control form-control-lg" name="twitter" />
                  <label class="form-label" for="form3Example4cdg">Twitter Link</label>
                </div>
